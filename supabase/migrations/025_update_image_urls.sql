...
DO $$
DECLARE
  t text := 'https://cnjykhdvbvewagfbbxwr.supabase.co/storage/v1/object/public/item-images/treatments/';
  d text := 'https://cnjykhdvbvewagfbbxwr.supabase.co/storage/v1/object/public/item-images/devices/';
BEGIN
